...
var (
	...
	CollectableMintableItemTypes    = id("CollectableMintableItemTypes")
	CollectibleMintTokenCount       = id("CollectibleMintTokenCount")
	CollectibleMintTokenOffers      = id("CollectibleMintTokenOffers")
	CollectibleMintableItemResult   = id("CollectibleMintableItemResult")
	CollectibleMintingEnabled       = id("CollectibleMintingEnabled")
	CollectibleWalletAddresses      = id("CollectibleWalletAddresses")
	...
	EmeraldBalance                  = id("EmeraldBalance")
	...
	NftBonusItemClaimResult         = id("NftBonusItemClaimResult")
	NftCollections                  = id("NftCollections")
	NftCollectionsScore             = id("NftCollectionsScore")
	NftRewardItemClaimResult        = id("NftRewardItemClaimResult")
	NftTransferAssetsResult         = id("NftTransferAssetsResult")
	NftTransferFee                  = id("NftTransferFee")
	...
	ObjectRemoveConfirm             = id("ObjectRemoveConfirm")
	...
	SilverBalance                   = id("SilverBalance")
	Sleep                           = id("Sleep")
	...
	TradeSilverFee                  = id("TradeSilverFee")
	TradeSilverSet                  = id("TradeSilverSet")
	...
	UserNftChatStyles               = id("UserNftChatStyles")
	...
	Whisper                         = id("Whisper")
	WiredAllVariableHolders         = id("WiredAllVariableHolders")
	WiredAllVariables               = id("WiredAllVariables")
	WiredErrorLogs                  = id("WiredErrorLogs")
	...
	WiredFurniVariable              = id("WiredFurniVariable")
	WiredMenuError                  = id("WiredMenuError")
	WiredMovements                  = id("WiredMovements")
	WiredPermissions                = id("WiredPermissions")
	WiredRewardResult               = id("WiredRewardResult")
	WiredRoomSettings               = id("WiredRoomSettings")
	WiredRoomStats                  = id("WiredRoomStats")
	WiredSaveSuccess                = id("WiredSaveSuccess")
	WiredValidationError            = id("WiredValidationError")
	WiredVariablesForObject         = id("WiredVariablesForObject")
	YouAreController                = id("YouAreController")
	YouAreNotController             = id("YouAreNotController")
	YouAreNotSpectator              = id("YouAreNotSpectator")
