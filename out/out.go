// Generated for release WIN63-202405301104-303662002 (source: sulek.dev)
...
var (
	...
	GetNftTransferFee                  = id("GetNftTransferFee")
	...
	GetUserNftChatStyles               = id("GetUserNftChatStyles")
	...
	NftTransferAssets                  = id("NftTransferAssets")
	Open                               = id("Open")
	...
	SetAreaHideData                    = id("SetAreaHideData")
	...
	UpdateVariable                     = id("UpdateVariable")
	...
	Whisper                            = id("Whisper")
	WiredClearErrorLogs                = id("WiredClearErrorLogs")
	WiredGetAllVariableHolders         = id("WiredGetAllVariableHolders")
	WiredGetAllVariables               = id("WiredGetAllVariables")
	WiredGetErrorLogs                  = id("WiredGetErrorLogs")
	WiredGetRoomSettings               = id("WiredGetRoomSettings")
	WiredGetRoomStats                  = id("WiredGetRoomStats")
	WiredGetVariablesForObject         = id("WiredGetVariablesForObject")
	WiredSetObjectVariableValue        = id("WiredSetObjectVariableValue")
	WiredSetPreferences                = id("WiredSetPreferences")
	WiredSetRoomSettings               = id("WiredSetRoomSettings")
